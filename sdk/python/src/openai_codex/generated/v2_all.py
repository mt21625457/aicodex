...
class Citation(BaseModel):
    ...
    cited_text: Annotated[str | None, Field(alias="citedText")] = None
    document_index: Annotated[int | None, Field(alias="documentIndex")] = None
    encrypted_index: Annotated[str | None, Field(alias="encryptedIndex")] = None
    end_char_index: Annotated[int | None, Field(alias="endCharIndex")] = None
    end_page_number: Annotated[int | None, Field(alias="endPageNumber")] = None
    provider: str
    raw: Any | None = None
    start_char_index: Annotated[int | None, Field(alias="startCharIndex")] = None
    start_page_number: Annotated[int | None, Field(alias="startPageNumber")] = None
    title: str | None = None
    type: str
    url: str | None = None
...
class OutputTextWithCitationsContentItem(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    text: str
    type: Annotated[
        Literal["output_text_with_citations"], Field(title="OutputTextWithCitationsContentItemType")
    ]
...
class ContextTokenUsageSource(Enum):
    provider_usage = "providerUsage"
    claude_count_tokens = "claudeCountTokens"
    deepseek_stream_usage = "deepseekStreamUsage"
    local_estimate = "localEstimate"
    in_flight_estimate = "inFlightEstimate"
    context_window_full = "contextWindowFull"
    replay = "replay"
...
class ThreadRuntimeLifecycle(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    active_turn_id: Annotated[
        str | None,
        Field(
            alias="activeTurnId",
            description="Identifier of the currently active turn, when app-server has one.",
        ),
    ] = None
    active_turn_started_at: Annotated[
        int | None,
        Field(
            alias="activeTurnStartedAt",
            description="Unix timestamp (in seconds) when the active turn started, if known.",
        ),
    ] = None
    last_terminal_turn_id: Annotated[
        str | None,
        Field(
            alias="lastTerminalTurnId",
            description="Identifier of the latest terminal turn observed by the live thread listener.",
        ),
    ] = None
...
class TranscriptMetadata(BaseModel):
    ...
    backend_item_id: Annotated[str | None, Field(alias="backendItemId")] = None
    event_sequence: Annotated[int | None, Field(alias="eventSequence")] = None
    order_index: Annotated[int | None, Field(alias="orderIndex")] = None
...
class ContentItem(
    RootModel[
        ...
        | OutputTextWithCitationsContentItem
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class ThreadGoalSetParams(BaseModel):
    ...
    replace_existing: Annotated[
        ...
        Field(
            ...
            description="Replace the current goal atomically, assigning a new ID and resetting usage.",
        ),
    ] = None
...
class UserMessageThreadItem(BaseModel):
    ...
    id: str
    transcript_metadata: Annotated[TranscriptMetadata | None, Field(alias="transcriptMetadata")] = (
        None
    )
...
class ThreadReadParams(BaseModel):
    ...
    items_view: Annotated[
        ...
        Field(
            alias="itemsView",
            description="How much item detail to include for each returned turn; defaults to full when `includeTurns` is true.",
        ),
    ] = None
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ThreadTokenUsage(BaseModel):
    ...
    context_source: Annotated[ContextTokenUsageSource | None, Field(alias="contextSource")] = None
    context_tokens: Annotated[int | None, Field(alias="contextTokens")] = None
...
class Thread(BaseModel):
    ...
    effort: Annotated[
        ReasoningEffort | None,
        Field(description="Latest observed reasoning effort for this thread."),
    ] = None
    ephemeral: Annotated[
        bool,
        Field(
    ...
    model_id: Annotated[
        ...
        Field(
            alias="modelId",
            description="Latest observed model for this thread, when recorded in thread metadata.",
        ),
    ] = None
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, aicodex exec, aicodex app-server, etc.)."
        ),
    ]
    ...
    wire_api: Annotated[
        ...
        Field(
            alias="wireApi",
            description="Wire protocol inferred for the recorded model/provider pair.",
        ),
    ] = None
...
class ThreadReadResponse(BaseModel):
    ...
    runtime_lifecycle: Annotated[
        ThreadRuntimeLifecycle | None,
        Field(
            alias="runtimeLifecycle",
            description="Lightweight, content-free runtime evidence for lifecycle reconciliation. Always serialized; `null` means no live snapshot. Older app-server builds may omit the field, and readers still accept that via `#[serde(default)]`.",
        ),
    ] = None
    thread: Thread
