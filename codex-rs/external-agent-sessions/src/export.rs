    ...
    fn builds_visible_turns_for_imported_history() {
        ...
        assert_eq!(
            ...
            ThreadItem::AgentMessage {
                ...
                phase: None,
                memory_citation: None,
                transcript_metadata: Some(codex_app_server_protocol::TranscriptMetadata {
                    turn_id: Some("external-import-turn-2".to_string()),
                    backend_item_id: Some("item-4".to_string()),
                    order_index: Some(1),
    ...
    fn adds_import_marker_without_copying_last_agent_message() {
        ...
        assert_eq!(
            ...
            Some(&ThreadItem::AgentMessage {
                ...
                memory_citation: None,
                transcript_metadata: Some(codex_app_server_protocol::TranscriptMetadata {
                    turn_id: Some("external-import-turn-1".to_string()),
                    backend_item_id: Some("item-3".to_string()),
                    order_index: Some(2),
