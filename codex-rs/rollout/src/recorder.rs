...
///
/// ```ignore
/// $ jq -C . ~/.aicodex/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.aicodex/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
...
fn precompute_new_rollout_path(
    ...
    // Resolve the AICodex sessions directory under the configured home.
