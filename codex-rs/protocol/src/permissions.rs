...
mod tests {
    ...
    fn filesystem_policy_blocks_protected_metadata_path_writes_by_default() {
        ...
        assert!(!file_system_policy.can_write_local_path_with_cwd(&dot_aicodex_config, cwd.path()));
    ...
    fn legacy_workspace_write_projection_accepts_relative_cwd() {
        ...
        assert!(
            !file_system_policy
                .can_write_local_path_with_cwd(Path::new(".aicodex/config.toml"), relative_cwd,)
        );
