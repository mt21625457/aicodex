...
fn realtime_request_trace_summary(
    ...
    let request_type = match message {
        ...
        RealtimeOutboundMessage::InputAudioAppend { .. } => "input_audio.append",
        RealtimeOutboundMessage::DelegationContextAppend { .. } => "delegation.context.append",
        RealtimeOutboundMessage::SessionContextAppend { .. } => "session.context.append",
        RealtimeOutboundMessage::SessionClose => "session.close",
        RealtimeOutboundMessage::ResponseCreate => "response.create",
        RealtimeOutboundMessage::SessionUpdate { .. } => "session.update",
        RealtimeOutboundMessage::FramelessSessionUpdate { .. } => "session.update",
