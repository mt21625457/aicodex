...
Set a stable path to the skill CLI (default `AICODEX_HOME` is `~/.aicodex`; `CODEX_HOME` is a compatibility fallback):

```
export AICODEX_HOME="${AICODEX_HOME:-${CODEX_HOME:-$HOME/.aicodex}}"
export CODEX_HOME="$AICODEX_HOME"
