...
#[derive(Debug, Parser)]
#[command(
    bin_name = "aicodex plugin marketplace add",
    after_help = "Examples:\n  aicodex plugin marketplace add ./path/to/marketplace\n  aicodex plugin marketplace add owner/repo --ref main\n  aicodex plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "aicodex plugin marketplace upgrade",
    after_help = "Examples:\n  aicodex plugin marketplace upgrade\n  aicodex plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "aicodex plugin marketplace remove",
    after_help = "Example:\n  aicodex plugin marketplace remove debug"
)]
