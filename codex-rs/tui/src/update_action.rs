...
pub enum UpdateAction {
    ...
    BunGlobalLatest,
    /// Update via `vp install -g @leagsoft/aicodex@latest`.
    VitePlusGlobalLatest,
    /// Update via `pnpm add -g @leagsoft/aicodex@latest`.
    PnpmGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            ...
            UpdateAction::VitePlusGlobalLatest => ("vp", &["install", "-g", "@leagsoft/aicodex"]),
            UpdateAction::PnpmGlobalLatest => ("pnpm", &["add", "-g", "@leagsoft/aicodex"]),
