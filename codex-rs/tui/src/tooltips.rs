...
const APP_TOOLTIP: &str = "Try the **Desktop app**. Run 'aicodex app' or visit https://chatgpt.com/codex?app-landing-page=true";
const MACOS_APP_TOOLTIP: &str =
    "Run `aicodex app` to open the Desktop app (it installs on macOS if needed).";
const LINUX_APP_TOOLTIP: &str = "Try the **Desktop app** on Linux: install it from https://learn.chatgpt.com/docs/linux/linux-app and run 'aicodex'.";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Desktop app**. Run 'aicodex app' or visit https://chatgpt.com/codex?app-landing-page=true";
