...
const APP_TOOLTIP: &str = "Try the **Codex App**. Run 'aicodex app' or visit https://chatgpt.com/codex?app-landing-page=true";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Codex App**. Run 'aicodex app' or visit https://chatgpt.com/codex?app-landing-page=true";
