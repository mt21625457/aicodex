...
resolve_version() {
  ...
  release_json="$(download_text "https://api.github.com/repos/leagsoft/aicodex/releases/latest")"
...
install_package_release() {
  ...
  chmod 0755 "$stage_release/bin/aicodex" "$stage_release/codex-path/rg"
